 ...
 */
public class RubyRSAPrivateKey extends RubyObject {

    private RSAPrivateKey pkey;

    protected RubyRSAPrivateKey(Ruby runtime, RubyClass type) {
        super(runtime, type);
    }
    
    public static void createKey(Ruby runtime, RubyModule mKey, RubyClass keyError) {
        RubyModule mPrivKey = mKey.defineModuleUnder("RSAPrivateKey");
        mPrivKey.defineAnnotatedMethods(RubyRSAPrivateKey.class);
    }
    ...
    private void getPrivateKeyFromBytes(byte[] privateKeyObject) throws GeneralSecurityException {
        ...
        pkey= (RSAPrivateKey) fac.generatePrivate(privKeySpec);
    }
