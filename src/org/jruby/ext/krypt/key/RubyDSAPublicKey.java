 ...
 */
public class RubyDSAPublicKey extends RubyObject {

    private DSAPublicKey pkey;

    protected RubyDSAPublicKey(Ruby runtime, RubyClass type) {
        super(runtime, type);
    }

    public static void createKey(Ruby runtime, RubyModule mKey, RubyClass keyError) {
        RubyModule mPubKey = mKey.defineModuleUnder("DSAPublicKey");
        mPubKey.defineAnnotatedMethods(RubyDSAPublicKey.class);
    }
    ...
    private void getPublicKeyFromBytes(byte[] pubKeyObject) throws GeneralSecurityException {
        ...
        pkey= (DSAPublicKey) fac.generatePublic(pubKeySpec);
    }
